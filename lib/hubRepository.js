...
class HubRepository {
    ...
    extractImage(tag, destDir) {
        return __awaiter(this, void 0, void 0, function* () {
            const index = yield this.getManifest(tag);
            ...
            const manifest = yield this.getManifest(digest);
    ...
    getManifest(tagOrDigest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headers = {
                Authorization: `Bearer ${this.token}`,
                Accept: [mediatype_1.MEDIATYPE_IMAGE_INDEX_V1, mediatype_2.MEDIATYPE_IMAGE_MANIFEST_LIST_V2, mediatype_1.MEDIATYPE_IMAGE_MANIFEST_V1, mediatype_2.MEDIATYPE_IMAGE_MANIFEST_V2].join(', ')
            };
